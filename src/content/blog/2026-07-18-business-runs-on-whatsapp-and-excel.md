---
title: "Your business runs on WhatsApp and Excel. Here's exactly when that breaks — and what replaces it"
slug: business-runs-on-whatsapp-and-excel
excerpt: "WhatsApp and Excel are the real operating system of Indian small
  business — and mostly, they're enough. The honest map of where they break,
  what custom software replaces at each break point, what it costs, and why
  the SaaS subscription treadmill isn't the only exit."
date: 2026-07-18T10:00:00.000+05:30
...
**What replaces it:** payments that carry their context — each one born attached to its order, campaign, or customer, verified automatically. I've written about the two levels of this: [when payment links are enough vs a real integration](/blog/razorpay-payment-links-vs-gateway-integration), and [attributing payments from multiple sources](/blog/razorpay-webhook-track-payments-by-source) when money arrives from several directions into one account.
...
Custom builds at these break points mostly land in the ₹20,000–₹40,000 one-time range, with full multi-role platforms above that — [my detailed brackets are here](/blog/how-much-does-a-custom-website-cost-in-india), and the recurring costs after a one-time build are [nearly zero and fully itemised here](/blog/website-costs-after-one-time-payment).
...
**Name your break point.** Tell me the one manual process that eats the most of your week — I'll tell you what would replace it and give you a fixed one-time quote. If Excel is still the right answer, I'll tell you that too. [Get in touch →](/contact)
